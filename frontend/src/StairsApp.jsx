...
export default function App() {
  ...
  const exportPDF = () => {
    ...
    <div class="header"><img src="${DEVONEERS_LOGO_URI}" style="height:32px;vertical-align:middle;margin-right:8px" alt="DEVONEERS" /><div><div style="font-size:14px;font-weight:700;color:#B8904A;letter-spacing:2px;margin-bottom:4px">ST.AIRS <span style="color:#64748b;font-weight:400;font-size:12px;letter-spacing:1px">&nbsp;|&nbsp; ${activeStrat?.name||"Strategy"} &nbsp;|&nbsp; ${new Date().toLocaleDateString()}</span></div><h1>${activeStrat?.name||"Strategy"}</h1><div style="font-size:12px;color:#64748b">${activeStrat?.company||""} · Staircase Export · ${new Date().toLocaleDateString()}</div></div></div>

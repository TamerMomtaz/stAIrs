        ...
        {loading ? (
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            {strategies.map(s => {
              ...
              return (
                <div key={s.id} className="group relative p-8 rounded-2xl transition-all hover:scale-[1.02] cursor-pointer flex flex-col focus:outline-none focus:ring-2 focus:ring-accent/40" style={{ ...glass(0.5), borderColor: `${tint(s.color || GOLD, 19)}`, flex: "1 1 320px", maxWidth: "380px", minHeight: "260px" }} {...clickable(() => onSelect(s), { label: s.name })}>
